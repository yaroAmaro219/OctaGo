...
@user = User.create( phone: "087654321", email: "user@email.com", password: "123456", admin: "true")
@user = User.create(phone: "0987654321", email: "user1@email.com", password: "123456", admin: "true")
@user = User.create(phone: "098765432", email: "user2@email.com", password: "123456", admin: "true")
@user = User.create(phone: "09876543", email: "user3@email.com", password: "123456", admin: "true")
@user = User.create(phone: "0987654", email: "user4@email.com", password: "123456", admin: "true")
@user = User.create(phone: "098765", email: "user5@email.com", password: "123456", admin: "true")
@user = User.create(phone: "098765", email: "user6@email.com", password: "123456", admin: "true")
@user = User.create(phone: "09876", email: "user7@email.com", password: "123456", admin: "true")
@user = User.create(phone: "09876", email: "user8@email.com", password: "123456", admin: "true")

@event = Event.create(title: "SuperBowl Half-Time Party by MasterCard", date: "February 8th 2021", location: "Gillette Stadium, Boston MA ", description: 'Come kick it', time: "12pm")
@event = Event.create(title: "US Open Cocktail Hour by Chase Bank", date: "August 5, 2021", location: "USTA Billie Jean King National Tennis Center, Queens NY", description: 'Come kick it', time: "12pm")
